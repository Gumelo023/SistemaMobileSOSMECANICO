...
public class CatalogoMecanicos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageList = {R.drawable.foto_gustavo, R.drawable.foto_matheus, R.drawable.foto_gustavo, R.drawable.foto_joao, R.drawable.foto_robson, R.drawable.foto_xavier, R.drawable.foto_luan};
